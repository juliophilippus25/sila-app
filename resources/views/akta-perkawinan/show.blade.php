        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            @if (auth()->user()->role == 'petugas' && $aktaPerkawinan->status == 'pending')
                <div class="flex justify-end mb-4">
                    @include('akta-perkawinan.partials.forms.verification-modal')
                </div>

                @include('akta-perkawinan.partials.forms.rejected-modal')
            @endif
            ...
            <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                ...
                <div x-data="{ tab: 'akta' }">
                    ...
                    <div>
                        <div x-show="tab === 'akta'">
                            @include('akta-perkawinan.partials.tabs-show.akta-perkawinan')
                        </div>
                        <div x-show="tab === 'suami'">
                            @include('akta-perkawinan.partials.tabs-show.data-suami')
                        </div>
                        <div x-show="tab === 'ayah_suami'">
                            @include('akta-perkawinan.partials.tabs-show.data-ayah-suami')
                        </div>
                        <div x-show="tab === 'ibu_suami'">
                            @include('akta-perkawinan.partials.tabs-show.data-ibu-suami')
                        </div>
                        <div x-show="tab === 'istri'">
                            @include('akta-perkawinan.partials.tabs-show.data-istri')
                        </div>
                        <div x-show="tab === 'ayah_istri'">
                            @include('akta-perkawinan.partials.tabs-show.data-ayah-istri')
                        </div>
                        <div x-show="tab === 'ibu_istri'">
                            @include('akta-perkawinan.partials.tabs-show.data-ibu-istri')
                        </div>
                        <div x-show="tab === 'saksi'">
                            @include('akta-perkawinan.partials.tabs-show.data-saksi')
                        </div>
                        <div x-show="tab === 'perkawinan'">
                            @include('akta-perkawinan.partials.tabs-show.data-perkawinan')
                        </div>
                        <div x-show="tab === 'administrasi'">
                            @include('akta-perkawinan.partials.tabs-show.data-administrasi')
                        </div>
                    </div>
                </div>
                {{-- End Tabs --}}
