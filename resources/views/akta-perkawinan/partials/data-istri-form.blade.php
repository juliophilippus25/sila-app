<section>
    ...
    <div class="mt-6 space-y-6">
        <div>
            ...
            <x-text-input id="di_nik" name="di_nik" type="text" class="mt-1 block w-full" />
            <x-input-error class="mt-2" :messages="$errors->get('di_nik')" />
        </div>

        <div>
            <x-input-label for="di_no_Kk" :value="__('Nomor Kartu Keluarga (Nomor KK)')" />
            <x-text-input id="di_no_Kk" name="di_no_Kk" type="text" class="mt-1 block w-full" />
        ...
        <div>
            ...
            <x-text-input id="di_alamat" name="di_alamat" type="text" class="mt-1 block w-full" />
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <x-text-input id="di_perkawinan_ke" name="di_perkawinan_ke" type="text"
                    class="mt-1 block w-full" />
