<section>
    ...
    <div class="mt-6 space-y-6">
        <div>
            ...
            <x-text-input id="dadi_nik" name="dadi_nik" type="text" class="mt-1 block w-full" required />
        ...
        <div>
            ...
            <x-text-input id="dadi_alamat" name="dadi_alamat" type="text" class="mt-1 block w-full" required />
        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
            <div>
                ...
                <x-text-input id="dadi_rt" name="dadi_rt" type="text" class="mt-1 block w-full" required />
                <x-input-error class="mt-2" :messages="$errors->get('dadi_rt')" />
            </div>

            <div>
                <x-input-label for="dadi_rw" :value="__('RW')" />
                <x-text-input id="dadi_rw" name="dadi_rw" type="text" class="mt-1 block w-full" required />
            ...
            <div>
                ...
                <x-text-input id="dadi_telepon" name="dadi_telepon" type="text" class="mt-1 block w-full" required />
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div>
                <x-select name="dadi_agama" label="Agama" :options="$agama" placeholder="Pilih Agama" required />
