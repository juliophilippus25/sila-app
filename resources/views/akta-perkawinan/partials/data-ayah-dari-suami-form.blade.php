<section>
    ...
    <div class="mt-6 space-y-6">
        <div>
            ...
            <x-text-input id="dads_nik" name="dads_nik" type="text" class="mt-1 block w-full" required />
        ...
        <div>
            ...
            <x-text-input id="dads_alamat" name="dads_alamat" type="text" class="mt-1 block w-full" required />
        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
            <div>
                ...
                <x-text-input id="dads_rt" name="dads_rt" type="text" class="mt-1 block w-full" required />
                <x-input-error class="mt-2" :messages="$errors->get('dads_rt')" />
            </div>

            <div>
                <x-input-label for="dads_rw" :value="__('RW')" />
                <x-text-input id="dads_rw" name="dads_rw" type="text" class="mt-1 block w-full" required />
            ...
            <div>
                ...
                <x-text-input id="dads_telepon" name="dads_telepon" type="text" class="mt-1 block w-full" required />
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div>
                <x-select name="dads_agama" label="Agama" :options="$agama" placeholder="Pilih Agama" required />
