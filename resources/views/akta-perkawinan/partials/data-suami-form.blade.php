<section>
    ...
    <div class="mt-6 space-y-6">
        <div>
            ...
            <x-text-input id="ds_nik" name="ds_nik" type="text" class="mt-1 block w-full" required />
            <x-input-error class="mt-2" :messages="$errors->get('ds_nik')" />
        </div>

        <div>
            <x-input-label for="ds_no_Kk" :value="__('Nomor Kartu Keluarga (Nomor KK)')" />
            <x-text-input id="ds_no_Kk" name="ds_no_Kk" type="text" class="mt-1 block w-full" required />
        ...
        <div>
            ...
            <x-text-input id="ds_alamat" name="ds_alamat" type="text" class="mt-1 block w-full" required />
        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
            <div>
                ...
                <x-text-input id="ds_rt" name="ds_rt" type="text" class="mt-1 block w-full" required />
                <x-input-error class="mt-2" :messages="$errors->get('ds_rt')" />
            </div>

            <div>
                <x-input-label for="ds_rw" :value="__('RW')" />
                <x-text-input id="ds_rw" name="ds_rw" type="text" class="mt-1 block w-full" required />
                <x-input-error class="mt-2" :messages="$errors->get('ds_rw')" />
            </div>

            <div>
                <x-input-label for="ds_kode_pos" :value="__('Kode Pos')" />
                <x-text-input id="ds_kode_pos" name="ds_kode_pos" type="text" class="mt-1 block w-full" required />
                <x-input-error class="mt-2" :messages="$errors->get('ds_kode_pos')" />
            </div>

            <div>
                <x-input-label for="ds_telepon" :value="__('Telepon')" />
                <x-text-input id="ds_telepon" name="ds_telepon" type="text" class="mt-1 block w-full" required />
        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
            <div>
                ...
                <x-text-input id="ds_kelurahan" name="ds_kelurahan" type="text" class="mt-1 block w-full" required />
                <x-input-error class="mt-2" :messages="$errors->get('ds_kelurahan')" />
            </div>

            <div>
                <x-input-label for="ds_kecamatan" :value="__('Kecamatan')" />
                <x-text-input id="ds_kecamatan" name="ds_kecamatan" type="text" class="mt-1 block w-full" required />
                <x-input-error class="mt-2" :messages="$errors->get('ds_kecamatan')" />
            </div>

            <div>
                <x-input-label for="ds_kabupaten" :value="__('Kabupaten/Kota')" />
                <x-text-input id="ds_kabupaten" name="ds_kabupaten" type="text" class="mt-1 block w-full" required />
                <x-input-error class="mt-2" :messages="$errors->get('ds_kabupaten')" />
            </div>

            <div>
                <x-input-label for="ds_provinsi" :value="__('Provinsi')" />
                <x-text-input id="ds_provinsi" name="ds_provinsi" type="text" class="mt-1 block w-full" required />
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div>
                <x-select name="ds_pendidikan_terakhir" label="Pendidikan Terakhir" :options="$pendidikanTerakhir"
                    placeholder="Pilih Pendidikan Terakhir" required />
                <x-input-error class="mt-2" :messages="$errors->get('ds_pendidikan_terakhir')" />
            </div>

            <div>
                <x-select name="ds_agama" label="Agama" :options="$agama" placeholder="Pilih Agama" required />
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <x-text-input id="ds_anak_ke" name="ds_anak_ke" type="text" class="mt-1 block w-full" required />
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div>
                ...
                <x-input-error class="mt-2" :messages="$errors->get('ds_status_perkawinan')" required />
            </div>

            <div>
                <x-input-label for="ds_perkawinan_ke" :value="__('Perkawinan Yang Ke')" />
                <x-text-input id="ds_perkawinan_ke" name="ds_perkawinan_ke" type="text" class="mt-1 block w-full"
                    required />
