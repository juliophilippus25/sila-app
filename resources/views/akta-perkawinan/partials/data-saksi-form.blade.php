<section>
    ...
    <div class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input id="ds_1_nik" name="ds_1[nik]" type="text" class="mt-1 block w-full" />
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div>
                ...
                <x-text-input id="ds_1_tempat_lahir" name="ds_1[tempat_lahir]" type="text"
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div>
                <x-select name="ds_1[agama]" label="Agama" :options="$agama" placeholder="Pilih Agama" />
    ...
    <div class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input id="ds_2_nama_lengkap" name="ds_2[nama_lengkap]" type="text"
                class="mt-1 block w-full" />
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div>
                <x-select name="ds_2[agama]" label="Agama" :options="$agama" placeholder="Pilih Agama" />
