<div class="space-y-2">
    ...
    <div class="flex">
        ...
        <span class="text-gray-900">:
            {{ jamIndo($hasAktaPerkawinan->perkawinanPerkawinan->pukul ?? '-') }}</span>
    </div>
    <div class="flex">
        <span class="w-64 font-semibold text-gray-700">Nama Badan Peradilan</span>
        <span class="text-gray-900">:
            {{ $hasAktaPerkawinan->perkawinanPerkawinan->nama_badan_peradilan ?? '-' }}</span>
    </div>
    <div class="flex">
        <span class="w-64 font-semibold text-gray-700">Nomor Putusan Penepatan Peradilan</span>
        <span class="text-gray-900">:
            {{ $hasAktaPerkawinan->perkawinanPerkawinan->nomor_putusan_pengadilan ?? '-' }}</span>
    </div>
    <div class="flex">
    ...
    <div class="flex">
        ...
        <span class="text-gray-900">:
            {{ $hasAktaPerkawinan->perkawinanPerkawinan->nama_pemuka_agama ?? '-' }}</span>
    </div>
    <div class="flex">
        <span class="w-64 font-semibold text-gray-700">Nama Organisasi Penghayat Kepercayaan</span>
        <span class="text-gray-900">:
            {{ $hasAktaPerkawinan->perkawinanPerkawinan->organisasi_penghayat ?? '-' }}</span>
    </div>
    <div class="flex">
        <span class="w-64 font-semibold text-gray-700">Ijin Perwakilan bagi WNA / Nomor</span>
        <span class="text-gray-900">:
            {{ $hasAktaPerkawinan->perkawinanPerkawinan->ijin_perwakilan ?? '-' }}</span>
    </div>
</div>
