<section>
    ...
    <div class="mt-6 space-y-6">
        <div>
            ...
            <x-text-input id="dids_nik" name="dids_nik" type="text" class="mt-1 block w-full" required />
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div>
                ...
                <x-text-input id="dids_tempat_lahir" name="dids_tempat_lahir" type="text"
                    class="mt-1 block w-full" />
                <x-input-error class="mt-2" :messages="$errors->get('dids_tempat_lahir')" required />
            </div>

            <div>
                <x-input-label for="dids_tanggal_lahir" :value="__('Tanggal Lahir')" />
                <x-text-input id="dids_tanggal_lahir" name="dids_tanggal_lahir" type="date"
                    class="mt-1 block w-full" />
                <x-input-error class="mt-2" :messages="$errors->get('dids_tanggal_lahir')" required />
            </div>
        </div>

        <div>
            <x-input-label for="dids_alamat" :value="__('Alamat')" />
            <x-text-input id="dids_alamat" name="dids_alamat" type="text" class="mt-1 block w-full" required />
        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
            <div>
                ...
                <x-text-input id="dids_rt" name="dids_rt" type="text" class="mt-1 block w-full" required />
                <x-input-error class="mt-2" :messages="$errors->get('dids_rt')" />
            </div>

            <div>
                <x-input-label for="dids_rw" :value="__('RW')" />
                <x-text-input id="dids_rw" name="dids_rw" type="text" class="mt-1 block w-full" required />
            ...
            <div>
                ...
                <x-text-input id="dids_telepon" name="dids_telepon" type="text" class="mt-1 block w-full" required />
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div>
                <x-select name="dids_agama" label="Agama" :options="$agama" placeholder="Pilih Agama" required />
