<section>
    ...
    <div class="mt-6 space-y-6">
        <div>
            ...
            <x-text-input id="didi_nik" name="didi_nik" type="text" class="mt-1 block w-full" required />
        ...
        <div>
            ...
            <x-text-input id="didi_alamat" name="didi_alamat" type="text" class="mt-1 block w-full" required />
        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
            <div>
                ...
                <x-text-input id="didi_rt" name="didi_rt" type="text" class="mt-1 block w-full" required />
                <x-input-error class="mt-2" :messages="$errors->get('didi_rt')" />
            </div>

            <div>
                <x-input-label for="didi_rw" :value="__('RW')" />
                <x-text-input id="didi_rw" name="didi_rw" type="text" class="mt-1 block w-full" required />
            ...
            <div>
                ...
                <x-text-input id="didi_telepon" name="didi_telepon" type="text" class="mt-1 block w-full" required />
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div>
                <x-select name="didi_agama" label="Agama" :options="$agama" placeholder="Pilih Agama" required />
